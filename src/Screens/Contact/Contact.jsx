...
const Contact = () => {
  ...
  return (
    <div className='w-11/12 mt-10 m-auto sm:w-3/6 sm:mt-20'>
      ...
      <p className={`font-semibold text-center ${textColor} leading-8 px-10`}>Actualmente estoydisponiblepara sumarme a tú equipo de desarrollo y desenvolver todos mis conocimientos.
